...
class CodeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        passwordTextField.backgroundColor = .systemTeal
...
//        top.isActive = true //레이아웃 활성화 -> constraints를 add해주는것
...
//
//        NSLayoutConstraint(item: passwordTextField, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .height, multiplier: 1, constant: 100).isActive = true
        ...
        let height = NSLayoutConstraint(item: passwordTextField, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .height, multiplier: 1, constant: 100)
        ...
        signButton.backgroundColor  = .brown
